...
const Intro = ({ translations }: { translations: any }) => {
  ...
  return (
    <section className="font-playfair mx-auto max-w-2xl px-4 sm:pb-6 lg:max-w-7xl lg:px-8">
      <div className="mb-8 flex flex-col flex-wrap justify-between md:flex-row md:mb-16">
        ...
        <div className="mb-2 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:pb-24 lg:pt-24 lg:w-2/5">
          <h4 className="h4 md:mb-2">{introTranslations.subheader}</h4>
          ...
          <Link href="/">
            <Button className="mt-8 text-black bg-background hover:bg-background w-fit">
